...
{
    public static System.Drawing.Color LineColor { get; set; } = System.Drawing.Color.FromArgb(16, 160, 255);

    public static int PixelsPerPoint => 4;
    ...
    {
        var maxPointCount = ActualWidth / PixelsPerPoint;
